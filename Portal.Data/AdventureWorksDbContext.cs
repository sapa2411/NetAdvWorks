...
namespace Portal.Data
{
    public partial class AdventureWorksDbContext : DbContext
    {
        ...
        public virtual DbSet<FactInternetSalesReason> FactInternetSalesReasons { get; set; }
...
//                optionsBuilder.UseSqlServer("Data Source=CODEHAKS\\MSSQL2019;Initial Catalog=AdventureWorksDW2019;integrated security=true");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FactInternetSalesReason>(entity =>
            {
                ...
                entity.ToTable("FactInternetSalesReason");

                entity.Property(e => e.SalesOrderNumber).HasMaxLength(20);

                entity.HasOne(d => d.SalesReasonKeyNavigation)
                    .WithMany(p => p.FactInternetSalesReasons)
